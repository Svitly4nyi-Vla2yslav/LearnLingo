import{u as n,R as h,F as A,r as g,d as K,e as k,g as G,j as t,h as V,i as J,E as j,k as $,B as Q,_ as P,a as X,b as Z,M as U,l as ee,m as te,n as L}from"./index-e0a16a38.js";const lt=e=>e.teacher.items,dt=e=>e.teacher.isLoading,ct=e=>e.teacher.error,ie=e=>e.favorites.items,pt=e=>e.favorites.isLoading,xt=e=>e.favorites.error,ne=n.ul`
 display: flex;
 mask-type: 28px;
...
`,z=n.img`
`,Re=n.img`
`,Me="/assets/book-open-93e734f4.svg",_e="/assets/star-84ec46ae.svg",Ye="/assets/face-53b4e4e1.png",De=n.div`
`,We=n.h2`
font-weight: 500;
font-size: 40px;
line-height: 1.2;
...
`,Qe=({teacher:e,close:i})=>{const[r,s]=g.useState(!1),[o,l]=g.useState(!1),[p,x]=g.useState(!1),c=K().shape({picked:k().required("Please select a reason for learning English"),fullname:k().min(2,"Too Short!").max(20,"Too Long!").required("Required"),email:k().email("Invalid email").required("Required"),phoneNuber:G().min(8,"Too Short!").required("Required")}),b=()=>{P.success("Сompleted successfully!"),i()};return t.jsxs(De,{children:[t.jsx(We,{children:"Book trial lesson"}),t.jsx(qe,{children:"Our experienced tutor will assess your current language level, discuss your learning goals, and tailor the lesson to your specific needs."}),t.jsxs(He,{children:[t.jsx(M,{src:e.avatar_url,loading:"lazy",alt:"avatar",width:"44",height:"44"}),t.jsxs(Ke,{children:[t.jsx(Ae,{children:"Your teacher"}),t.jsxs(Ge,{children:[e.name," ",e.surname]})]})]}),t.jsx(Ve,{children:"What is your main reason for learning English?"}),t.jsx(V,{initialValues:{picked:"",fullname:"",email:"",phoneNuber:""},onSubmit:b,validationSchema:c,children:({})=>t.jsxs(J,{children:[t.jsxs(Je,{role:"group","aria-labelledby":"my-radio-group",children:[t.jsxs(m,{children:[t.jsx(f,{type:"radio",name:"picked",value:"Career and business"}),"Career and business"]}),t.jsxs(m,{children:[t.jsx(f,{type:"radio",name:"picked",value:"Lesson for kids"}),"Lesson for kids"]}),t.jsxs(m,{children:[t.jsx(f,{type:"radio",name:"picked",value:"Living abroadwo"}),"Living abroad"]}),t.jsxs(m,{children:[t.jsx(f,{type:"radio",name:"picked",value:"Exams and coursework"}),"Exams and coursework"]}),t.jsxs(m,{children:[t.jsx(f,{type:"radio",name:"picked",value:"Culture, travel or hobby"}),"Culture, travel or hobby"]}),t.jsx(j,{name:"picked",component:"div"})]}),t.jsx($,{name:"fullname",placeholder:r?"":"Full Name",onFocus:()=>s(!0)}),t.jsx(j,{name:"fullname",component:"div"}),t.jsx($,{type:"email",name:"email",placeholder:o?"":"Email",onFocus:()=>l(!0)}),t.jsx(j,{name:"email",component:"div"}),t.jsx($,{type:"tel",name:"phoneNuber",placeholder:p?"":"Phone number",onFocus:()=>x(!0)}),t.jsx(j,{name:"phoneNuber",component:"div"}),t.jsx(Q,{type:"submit",children:"Book"})]})})]})},Xe=({teacher:e,authUser:i})=>{const[r,s]=g.useState(!1),[o,l]=g.useState(null),[p,x]=g.useState(null),c=X(),b=Z(ie),S=()=>{s(a=>!a)},_=a=>{x(a),S()},Y=()=>{s(!1)},D=a=>{l(u=>u===a?null:a)},W=a=>o===a?"Hide more":"Read More",E=b&&b.some(a=>a&&a.id===e.id),q=()=>{i?c(E?te({userId:i.uid,teacherId:e.id}):ee({userId:i.uid,teacher:e})):P("You need to log in at first!",{icon:"❗"})};return t.jsxs(t.Fragment,{children:[t.jsx(he,{children:t.jsx(M,{src:e.avatar_url,loading:"lazy",alt:"avatar",width:"96",height:"96"})}),t.jsxs(ue,{children:[t.jsxs(ge,{children:[t.jsx(me,{children:"Languages"}),t.jsxs(fe,{children:[t.jsx(y,{children:t.jsxs(N,{children:[" ",t.jsx(Re,{src:Me,alt:"📖"})," Lessons online"]})}),t.jsxs(y,{children:["Lessons done: ",e.lessons_done]}),t.jsx(y,{children:t.jsxs(N,{children:[" ",t.jsx(z,{src:_e,alt:"⭐"})," Rating: ",e.rating]})}),t.jsxs(y,{children:["Price / 1 hour: ",t.jsxs(be,{children:[e.price_per_hour,"$"]})]}),t.jsxs("li",{children:[" ",t.jsx(je,{type:"button",onClick:q,children:E&&i?t.jsx(ve,{}):t.jsx(ye,{})})]})]})]}),t.jsxs(we,{children:[" ",e.name," ",e.surname," "]}),t.jsxs(ke,{children:[t.jsx(C,{children:t.jsxs(Ce,{children:[t.jsx(O,{children:"Speaks:  "}),t.jsx($e,{children:e.languages?e.languages.map((a,u,H)=>t.jsxs(h.Fragment,{children:[t.jsx("li",{children:a}),u<H.length-1&&t.jsx("span",{children:",  "})]},a)):t.jsx("li",{children:"No languages available"})})]})}),t.jsxs(C,{children:[t.jsx(O,{children:"Lesson info:"})," ",e.lesson_info]}),t.jsxs(C,{children:[t.jsx(O,{children:"Conditions:"})," ",e.conditions]})]}),o===e.id&&t.jsxs("div",{children:[t.jsx(Le,{children:e.experience}),t.jsx(Se,{children:e.reviews?e.reviews.map((a,u)=>t.jsxs("li",{children:[t.jsxs(Te,{children:[t.jsx(Ee,{src:Ye,alt:"avatar",width:"44",height:"44",loading:"lazy"}),t.jsxs(Be,{children:[t.jsx("p",{children:a.reviewer_name}),t.jsxs(Pe,{children:[t.jsx(z,{}),t.jsxs("p",{children:[" ",a.reviewer_rating," ⭐"]})]})]})]}),t.jsx(Ie,{children:a.comment})]},u)):t.jsx("li",{children:"There are no reviews yet"})})]}),t.jsxs(Oe,{onClick:()=>D(e.id),children:[" ",W(e.id)]}),t.jsx(Ne,{children:e.levels?e.levels.map((a,u)=>t.jsx(ze,{children:t.jsx("p",{children:a})},u)):t.jsx("li",{children:"No levels"})}),o===e.id&&t.jsx(Fe,{type:"button",onClick:()=>_(e),children:"Book trial lesson"})]}),r&&p&&t.jsx(U,{toggleModal:S,children:t.jsx(Qe,{teacher:p,close:Y})})]})},ht=({authUser:e,teachers:i})=>t.jsx(ne,{children:i&&Array.isArray(i)&&i.map(r=>t.jsx(re,{children:r&&t.jsx(Xe,{authUser:e,teacher:r})},r==null?void 0:r.id))}),Ze="#4fa94d",Ue={"aria-busy":!0,role:"progressbar"},et=n.div`
  display: ${e=>e.$visible?"flex":"none"};
`,tt="http://www.w3.org/2000/svg",d=242.776657104492,it=1.6,nt=L`
12.5% {
...
`;n.path`
  ...
  stroke-dashoffset: 0;
  animation: ${nt} ${it}s linear infinite;
`;const rt=({height:e=80,width:i=80,radius:r=6,color:s=Ze,ariaLabel:o="rings-loading",wrapperStyle:l,wrapperClass:p,visible:x=!0})=>t.jsx(et,{style:l,$visible:x,className:p,"data-testid":"rings-loading","aria-label":o,...Ue,children:t.jsx("svg",{width:i,height:e,viewBox:"0 0 45 45",xmlns:tt,stroke:s,"data-testid":"rings-svg",children:t.jsxs("g",{fill:"none",fillRule:"evenodd",transform:"translate(1 1)",strokeWidth:"2",children:[t.jsxs("circle",{cx:"22",cy:"22",r,strokeOpacity:"0",children:[t.jsx("animate",{attributeName:"r",begin:"1.5s",dur:"3s",values:"6;22",calcMode:"linear",repeatCount:"indefinite"}),t.jsx("animate",{attributeName:"stroke-opacity",begin:"1.5s",dur:"3s",values:"1;0",calcMode:"linear",repeatCount:"indefinite"}),t.jsx("animate",{attributeName:"stroke-width",begin:"1.5s",dur:"3s",values:"2;0",calcMode:"linear",repeatCount:"indefinite"})]}),t.jsxs("circle",{cx:"22",cy:"22",r,strokeOpacity:"0",children:[t.jsx("animate",{attributeName:"r",begin:"3s",dur:"3s",values:"6;22",calcMode:"linear",repeatCount:"indefinite"}),t.jsx("animate",{attributeName:"strokeOpacity",begin:"3s",dur:"3s",values:"1;0",calcMode:"linear",repeatCount:"indefinite"}),t.jsx("animate",{attributeName:"strokeWidth",begin:"3s",dur:"3s",values:"2;0",calcMode:"linear",repeatCount:"indefinite"})]}),t.jsx("circle",{cx:"22",cy:"22",r:Number(r)+2,children:t.jsx("animate",{attributeName:"r",begin:"0s",dur:"1.5s",values:"6;1;2;3;4;5;6",calcMode:"linear",repeatCount:"indefinite"})})]})})}),st=L`
to {
...
`;const ut=()=>t.jsx("div",{style:{display:"flex",justifyContent:"center",marginTop:"300px"},children:t.jsx(rt,{visible:!0,height:"150",width:"150",color:"#F4C550",ariaLabel:"rings-loading",wrapperStyle:{},wrapperClass:""})});export{ht as C,ut as M,dt as a,ct as b,ie as c,pt as d,xt as e,lt as s};
